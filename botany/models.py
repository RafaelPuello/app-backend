...
class PlantGalleryImage(models.Model):
    plant = ParentalKey(Plant, on_delete=models.CASCADE, related_name="gallery_images")
...
class PlantJournalEntry(models.Model):
    plant = ParentalKey(Plant, related_name="journal_entries", on_delete=models.CASCADE)
